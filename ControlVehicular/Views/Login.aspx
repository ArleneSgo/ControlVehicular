<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ControlVehicular.Views.Login" %>
<!DOCTYPE html>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="d-flex justify-content-center py-4">
                                <a class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">UGRS</span>
                                </a>
                            </div><!-- End Logo -->
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" runat="server" novalidate>
                                        <div class="col-12">
                                            ...
                                            <asp:TextBox ID="txtUserName" name="username" class="form-control" runat="server"  placeholder="Usuario" text="jose moreno" required ></asp:TextBox>
                                            <div class="invalid-feedback">Usuario requerido</div>
                                        </div>
                                        <div class="col-12">
                                            <label for="txtPassword" class="form-label">Contraseña</label>
                                            <%--<input type="password" name="password" class="form-control" id="yourPassword" required>--%>
                                            <asp:TextBox ID="txtPassword" name="password" class="form-control" runat="server" placeholder="Contraseña" Text="ugrs123" required></asp:TextBox>
                                            <div class="invalid-feedback">Contraseña requerida</div>
                                        </div>
                                        <div class="col-12">
                                            <div class="alert alert-danger mt-1" role="alert" runat="server" visible="false" id="errorMessage">Usuario y/o contraseña incorrectos</div>
